        ...
        <div className=" flex items-center gap-4">
          ...
          <p
            className={`text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md ${
              (data.sts === "preparing" && "text-purple-500 bg-orange-100") ||
              (data.sts === "cancelled" && "text-purple-500 bg-red-100") ||
          ...
          {admin && (
            <div className="flex items-center justify-center gap-2">
              ...
              <motion.p
                ...
                className={`text-purple-500 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Preparing
              </motion.p>
              ...
              >
                ...
                <div className="flex items-start flex-col">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="flex items-center gap-1 text-textColor">
                      <HiCurrencyRupee className="text-base text-purple-500" />
