    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6">
        <div className="px-4 py-1 flex items-center justify-center gap-2 bg-orange-100 rounded-full">
          <p className="text-lg font-semibold text-purple-500">Free Delivery</p>
        ...
        <p className="text-[40px] text-headingColor md:text-[72px] font-sans font-extrabold tracking-wider">
          ...
          <span className="text-purple-600">Your City</span>
        </p>

        <p className="text-textColor text-lg">
        Cooksoo. ​Кафе паназиатской кухни. Наш рейтинг 3.8. Бесплатная доставка при заказе от 1000 сомов
        </p>
        <motion.button
          {...buttonClcik}
          className="bg-gradient-to-bl from-purple-400 to-purple-600 px-4 py-2 rounded-xl text-black text-base font-semibold"
        >
          Order Now
        </motion.button>
      </div>
