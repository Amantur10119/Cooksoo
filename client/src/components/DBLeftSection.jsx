  ...
  return (
    <div className="h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-210 w-300 gap-3">
      <NavLink to={"/"} className="flex items-center justify-start px-6 gap-4">
        ...
        <p className="font-semibold text-xl">Cooksoo</p>
      </NavLink>
      ...
      <ul className="flex flex-col gap-4">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? `${isActiveStyles} px-4 py-2 border-l-8  border-purple-500`
              : isNotActiveStyles
          }
        >
          Home
      ...
      <div className="w-full items-center justify-center flex h-225 mt-auto px-2 ">
        <div className="w-full h-full rounded-md bg-purple-400 flex items-center justify-center flex-col gap-3 px-3">
          ...
          <p className="text-base text-gray-300 text-center">
            Having trouble in Cooksoo. Please contact us for more questions
          </p>
          <p className="px-4 py-2 rounded-full bg-primary text-purple-400 cursor-pointer">
            Get in touch
          </p>
        </div>
      </div>
