    ...
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
                ...
                <>
                  <div className="relative w-full h-full overflow-hidden rounded-md">
                    ...
                    <motion.button
                      {...buttonClcik}
                      type="button"
                      className="absolute top-3 right-3 p-3 rounded-full bg-purple-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out"
        ...
        <motion.button
          ...
          {...buttonClcik}
          className="w-9/12 py-2 rounded-md bg-purple-400 text-primary hover:bg-purple-500 cursor-pointer"
        >
          Save
        </motion.button>
      </div>
