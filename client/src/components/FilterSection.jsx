    ...
    <motion.div className="w-full flex items-start justify-start flex-col">
      <div className=" w-full flex items-center justify-between ">
        <div className="flex flex-col items-start justify-start gap-1">
          ...
          <div className="w-40 h-1 rounded-md bg-purple-500"></div>
        </div>
      </div>
  ...
  return (
    <motion.div
      ...
      className={`group w-28 min-w-[128px] cursor-pointer rounded-md  py-6 ${
        category === data.category ? "bg-purple-500" : "bg-primary"
    ...
    >
      <div
        className={`w-10 h-10 rounded-full shadow-md flex items-center justify-center group-hover:bg-primary ${
          category === data.category ? "bg-primary" : "bg-purple-500"
        }`}
      >
        <IoFastFood
          className={`${
            category === data.category ? "text-purple-500" : "text-primary"
